...
#### 3) Импортирование базы: CREATE DATABASE new_database; use new_database; source register-db.sql
#### 4) Зайти в файл connect.php и указать название базы, логин, пароль и хост
